...
namespace WebAPIWithRDLC.DataSet {
    ...
    public partial class dsUser : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string FirstName, string LastName, string Email, string Phone) {
...
namespace WebAPIWithRDLC.DataSet.dsUserTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Users] WHERE (([UsersId] = @Original_UsersId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Users] ([FirstName], [LastName], [Email], [Phone]) VALUES (@FirstNam" +
                "e, @LastName, @Email, @Phone);\r\nSELECT UsersId, FirstName, LastName, Email, Phon" +
                "e FROM Users WHERE (UsersId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Users] SET [FirstName] = @FirstName, [LastName] = @LastName, [Email] = @Email, [Phone] = @Phone WHERE (([UsersId] = @Original_UsersId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT UsersId, FirstName, LastName, Email, Phone FROM Users WHERE (UsersId = @UsersId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=dglnlo-821684-1;Initial Catalog=assessmentdb;Integrated Security=True" +
                "";
        }
        ...
        public virtual int Delete(int Original_UsersId, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Phone) {
        ...
        public virtual int Update(string FirstName, string LastName, string Email, string Phone, int Original_UsersId, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Phone, int UsersId) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Email, string Phone, int Original_UsersId, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Phone) {
            return this.Update(FirstName, LastName, Email, Phone, Original_UsersId, Original_FirstName, Original_LastName, Original_Email, Original_Phone, Original_UsersId);
        }
    }
}
